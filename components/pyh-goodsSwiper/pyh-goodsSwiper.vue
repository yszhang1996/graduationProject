<template>
	<view class="goodsSwiperBox" v-show="detail">
		...
		<swiper class="gswSw" v-if="detail.list&&detail.list.length>0" :display-multiple-items="config.multiple||3" :autoplay="config.autoplay" next-margin="100rpx" @change="swiperChange" :disable-touch="disable">
