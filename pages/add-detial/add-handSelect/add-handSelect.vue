		...
		<view class="bg-f1 h-100vh">
			...
			<movable-area :style="'height:' + (seatRow * 40 + 350) + 'rpx;width: 100vw;top:' + rpxNum * 132 + 'px'" class="pt-f left-0">
				...
				>
					...
					<!-- <view class="pt-f pa-v-2 b-d-1" :style="'height:'+seatRow*(20+seatSize*pxNum)+'rpx;top:10rpx;width:0'"></view> -->
					<!-- 中轴线 -->
					<view v-for="(item, index) in seatArray" :key="index" class="dp-f jc-c mt-20" :style="'width:' + boxWidth + 'px;height:' + seatSize + 'px'">
						...
						>
							...
							<image v-else-if="seat.type === 2" class="w-100 h-100" src="../../../static/img/selectSeat/bought.png" mode="aspectFit"></image>
						</view>
					</view>
					<!-- <view class="pt-f bg-line br-15 over-h" :style="'left: '+(10-moveX/scale)+'px;top:10rpx;width:30rpx;'">
			...
			<view class="pt-f bottom-bar left-0 dp-f fd-cr z1000">
				<view class="bg-white p-all-32">
					...
					<view style="width: 686rpx;height: 90rpx;" class="dp-f jc-c ai-c br-10 fz-34 color-fff" :class="SelectNum > 0 ? 'bg-red-1' : 'bg-unbtn'" @click="buySeat">
						{{ SelectNum > 0 ? '￥ ' + aPrice + '/每小时 确认座位' : '请选座位' }}
					</view>
				</view>
				<view class="dp-f jc-c ai-c mb-20 fz-28" v-if="showTis">
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:' + seatSize + 'px;height:' + seatSize + 'px'" src="../../../static/img/selectSeat/unselected.png" mode="aspectFit"></image>
						<span class="ml-10">可选</span>
					</view>
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:' + seatSize + 'px;height:' + seatSize + 'px'" src="../../../static/img/selectSeat/bought.png" mode="aspectFit"></image>
						<span class="ml-10">不可选</span>
					</view>
					<view class="dp-f jc-c ai-c m-0-10">
						<image :style="'width:' + seatSize + 'px;height:' + seatSize + 'px'" src="../../../static/img/selectSeat/selected.png" mode="aspectFit"></image>
...
.sel-seat {
	background: url('../../../static/img/selectSeat/selected.png') center center no-repeat;
	background-size: 100% 100%;
}

.unsel-seat {
	background: url('../../../static/img/selectSeat/unselected.png') center center no-repeat;
	background-size: 100% 100%;
}
